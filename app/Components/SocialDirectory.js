...
export default function SocialDirectory() {
    return (
        <div>
            ...
            <SocialButton path='/socials/itunes.png' link='https://twitter.com/indremusic'  alt='Apple Music'/>
            ...
            <SocialButton path='/socials/twitter.png' link='https://music.apple.com/gb/artist/indr%C3%A9/1439515994' alt='Twitter'/>
        </div>
    );
}